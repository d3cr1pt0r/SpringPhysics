...
class VerletTest(Game):
    ...
    def start(self):
        self.p1 = VerletPointContained(position=sf.Vector2(100, 100), size=5, mass=1, bounce=0.8, friction=0.999, gravity=sf.Vector2(0, 0.1))
        self.p2 = VerletPointContained(position=sf.Vector2(200, 100), size=5, mass=1, bounce=0.8, friction=0.999, gravity=sf.Vector2(0, 0.1))
        self.p3 = VerletPointContained(position=sf.Vector2(150, 50), size=5, mass=1, bounce=0.8, friction=0.999, gravity=sf.Vector2(0, 0.1))
